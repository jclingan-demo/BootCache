...
For more details on using this booster with a single-node OpenShift cluster, CI/CD deployments, as well as the rest of the runtime, see the link:http://appdev.openshift.io/docs/spring-boot-runtime.html[Spring Boot Runtime Guide].
====
...
----
$ git clone git@github.com:jclingan-demo/BootCache
...
[source,bash,options="nowrap",subs="attributes+"]
----
$ oc get route spring-boot-cache-greeting -o jsonpath={$.spec.host}

spring-boot-cache-greeting-MY_PROJECT_NAME.LOCAL_OPENSHIFT_HOSTNAME
----
